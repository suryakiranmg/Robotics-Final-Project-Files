...
run_balance_task(void)
{
    ...
    switch (which_step) {
        ...
        case ASSIGN_COG_TARGET_R: // balance shift right
            ...
            cog_target.x[_X_] = (count == 0) ? cog_des.x[_X_] + 0.05  : cog_des.x[_X_] + 0.08; // pos: right
            cog_target.x[_Y_] = (count == 0) ?  0.015 : cog_des.x[_Y_] + 0.04; // pos: forward
...
//            target[L_AFE].th = -0.04;// neg means go down
        ...
        case ASSIGN_JOINT_TARGET_LIFT_UP_L:
            ...
            target[R_HFE].th = 0.8; //+= 0.5;
            target[R_KFE].th = 0.6; //+= 1.0;
            target[R_AFE].th = 0.2; //+= 0.5;// neg means go down
        ...
        case ASSIGN_JOINT_TARGET_LIFT_DOWN_L:
            ...
            target[R_HFE].th = 0.2; //0.1; //-= 0.5; // used to be 0.2
